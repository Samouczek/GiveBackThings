...
export const foundations = [
      ...
      ["Fundacja “Dla dzieci”","Cel i misja: Pomoc dzieciom z ubogich rodzin.",
        ...
        ["Fundacja Zbieramy razem", "Cel i misja: Pomoc dla osób niepełnosprawnych lub ciężko chorych",
            "ubrania, jedzenie, sprzęt AGD, pieniądze"],
        ["Fundacja “Mimo wszytsko”","Cel i misja: Pomoc dla osób  dorosłych z niepełnosprawnością intelektualną. ",
            "ubrania, meble, sprzęt AGD"],
        ["Fundacja Chcę żyć", "Cel i misja: Pomoc dla dzieci chorych na trudno uleczalne choroby.",
            "ubrania, zabawki, jedzenie"],
        ["Fundacja “Dzieci.org”", "Cel i misja: Pomoc dla dzieci i młodzieży niepełnospprawnej.",
            "ubrania, jedzenie, sprzęt AGD, meble, zabawki"],
        ["Fundacja Dziecięce Marzenia","Cel i misja: Pomoc dzieciom z ubogich rodzin.",
            "ubrania, meble, zabawki, jedzenie"],
        ["Fundacja Ekologicznych Rozwiązań", "Cel i misja: Podniesienie świadomości ekologicznej społeczeństwa.",
...
export const nonGovernmentalOrganizations = [
    ...
    ["Organizacja “Lorem Ipsum 4”", "Quis varius quam quisque id diam vel elementum pulvinar.","Egestas, sed, tempus"],
